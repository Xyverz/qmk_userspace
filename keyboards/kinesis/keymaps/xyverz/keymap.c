...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FNLAYER] = LAYOUT(
    ...
    KC_CAPS,  KC_TRNS,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_TRNS,                                                                   TG(1),    TG(3),    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
  ...
  [KWERTY] = LAYOUT(
    ...
    KC_GRV,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,                                                                      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLNS, KC_QUOT,
    KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                                                                      KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
              KC_EQL,   KC_MINS,  KC_LEFT,  KC_RGHT,                                                                                       KC_UP,    KC_DOWN,  KC_MINS,  KC_RBRC,
                                                      KC_LCTL,  KC_LALT,                                               KC_RGUI,  KC_RCTL,
                                                                KC_LGUI,                                               KC_RGUI,
                                            KC_BSPC,  KC_DEL,   MO(2),                                                 MO(2),    KC_ENT,   KC_SPC
  ),
