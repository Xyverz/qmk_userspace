...
#define QWERTY 2 // QWERTY Layer for Games that suck so much they won't let me remap certain Dvorak keys because their developers suck as people
#define FNLAYER 3 // Function Layer
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FNLAYER] = LAYOUT(
    ...
    KC_CAPS,  KC_TRNS,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_TRNS,                                                                   TG(1),    TG(2),    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
